...
const stats = [
  ...
  { icon: FiTruck, value: '500+', label: 'Restaurants' },
];

const StatsSection = () => {
  return (
    <section className="py-16 bg-gradient-to-r from-red-50 to-orange-50 dark:from-gray-800 dark:to-gray-900 transition-colors duration-200">
          ...
          {stats.map((stat, index) => (
            ...
            >
              <div className="inline-flex p-4 bg-red-100 dark:bg-red-900/30 rounded-2xl mb-4">
                <stat.icon className="text-3xl text-red-600 dark:text-red-400" />
              </div>
